...
export function LyricLine({
  ...
  let containerClasses = 'lyric-line-editor flex items-center gap-2.5 mb-2.5 p-2 border-2 rounded transition-all cursor-pointer';
  ...
  if (isSelected) {
    ...
    containerClasses += ' bg-yellow-50 dark:bg-yellow-900/20 border-yellow-400 dark:border-yellow-600';
  } else if (disabled) {
    containerClasses += ' opacity-50 bg-gray-100 dark:bg-gray-900 border-gray-300 dark:border-gray-600';
  } else {
    // Default state
    containerClasses += ' bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-750 hover:border-gray-400 dark:hover:border-gray-500';
  }
